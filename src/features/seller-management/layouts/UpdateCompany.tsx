...
const UpdateCompany = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    await updateCompany(formData.companyId);
  };

  useEffect(() => {
    if (id) {
      fetchCompanyDetailsById(parseInt(id));
    }
  }, [id]);
  ...
  return (
    <div className='flex flex-col h-full bg-gray-50'>
      ...
      <div className='flex-shrink-0 bg-gradient-to-r from-blue-600 to-blue-800 text-white px-8 py-6 shadow-lg'>
        <h1 className='text-3xl font-bold'>Update Supplier Company</h1>
        <p className='text-blue-100 text-sm mt-2'>Edit supplier company information</p>
      </div>
          ...
          <div className='bg-white rounded-xl shadow-md p-8'>
            <form onSubmit={handleSubmit}>
              ...
              <div className='flex flex-col items-center mb-8 pb-8 border-b border-gray-200'>
                ...
                <p className='text-sm text-gray-600 mt-4'>Update logo URL below</p>
              </div>
